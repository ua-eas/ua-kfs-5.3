...
public class ExpiredOrClosedAccountEntry {
    ...
    public void setOriginalAccount(ExpiredOrClosedAccount originalAccount) {
        this.originalAccount = originalAccount;
    }

    public void setReplacementAccount(ExpiredOrClosedAccount replacementAccount) {
        this.replacementAccount = replacementAccount;
    }
}
