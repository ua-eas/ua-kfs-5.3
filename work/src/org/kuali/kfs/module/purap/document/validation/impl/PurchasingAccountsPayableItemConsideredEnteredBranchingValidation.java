...
public class PurchasingAccountsPayableItemConsideredEnteredBranchingValidation extends BranchingValidation {
    ...
    public static final String NEEDS_INDIVIDUAL_ITEM_VALIDATION = "needsIndividualItemValidation";
    
    private PurApItem itemForValidation;

    @Override
    protected String determineBranch(AttributedDocumentEvent event) {
        if (itemForValidation.isConsideredEntered()) {
            return NEEDS_INDIVIDUAL_ITEM_VALIDATION;
        } else {
